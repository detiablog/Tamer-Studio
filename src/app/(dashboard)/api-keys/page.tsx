      ...
      <PageLayout
        ...
        actions={
          <ActionButton onClick={handleCreate} disabled={creating}>
            {creating ? t("apiKeys.creating", "Creating...") : t("apiKeys.createKey", "Create Key")}
          </ActionButton>
        }
      >
        <div className="space-y-6">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <StatCard title={t("apiKeys.totalRequests", "Total Requests")} value="3,420" delta={t("apiKeys.deltaPlus120Today", "+120 today")} />
            <StatCard title={t("apiKeys.lastRotation", "Last Rotation")} value={t("apiKeys.delta30DaysAgo", "30 days ago")} delta={t("apiKeys.deltaRecommended90Days", "Recommended: 90 days")} />
            <StatCard title={t("apiKeys.securityScore", "Security Score")} value={t("apiKeys.scoreGood", "Good")} delta={t("apiKeys.scoreNoExposedKeys", "No exposed keys")} />
          </div>
