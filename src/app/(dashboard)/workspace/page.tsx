    ...
    <div className="grid gap-6 lg:grid-cols-3">
      <div className="lg:col-span-3">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <StatCard title={t("admin.roles")} value={uniqueRoles} delta={t("dashboard.delta.roles", "Admin, Editor, Viewer")} />
          <StatCard title={t("admin.storageLimit")} value="N/A" delta={t("dashboard.delta.storage", "of 100 GB")} />
        </div>
      </div>
