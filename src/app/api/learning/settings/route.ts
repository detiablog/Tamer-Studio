...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const settings = await learningCollectorService.checkSettings(userId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const settings = await learningCollectorService.updateSettings(userId, {
      learningEnabled: body.learningEnabled,
      learningPaused: body.learningPaused,
      confidenceThreshold: body.confidenceThreshold,
      maxEventsPerDay: body.maxEventsPerDay,
