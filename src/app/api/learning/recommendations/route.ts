...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const result = await recommendationEngineService.listRecommendations(userId, {
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await recommendationEngineService.generateRecommendations(userId);
