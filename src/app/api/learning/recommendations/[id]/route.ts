...
export async function GET(
  ...
  try {
    ...
    const recommendation = await recommendationEngineService.getRecommendation(id);
    if (!recommendation) {
...
export async function PUT(
  ...
  try {
    ...
    const updated = await recommendationEngineService.updateStatus(id, body.status);
...
export async function DELETE(
  ...
  try {
    ...
    const { id } = await params;
    await recommendationEngineService.deleteRecommendation(id);
