...
export async function GET(request: NextRequest) {
  ...
  try {
    const collections = await assetManagementService.getCollections(ctx.state.userSession!.userId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const collection = await assetManagementService.createCollection(
      body.name,
