...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const pipelineStats = await pipelineBuilderService.getStats();
    const queueStats = await queueManagerService.getStats(userId);
    const ruleStats = await automationRulesService.getStats(userId);
