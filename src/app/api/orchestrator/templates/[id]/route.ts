...
export async function GET(
  ...
  try {
    ...
    const template = await pipelineBuilderService.getTemplate(id);
    if (!template) {
...
export async function PUT(
  ...
  try {
    ...
    const updated = await pipelineBuilderService.updateTemplate(id, {
      name: body.name,
...
export async function DELETE(
  ...
  try {
    ...
    await pipelineBuilderService.deleteTemplate(id);
