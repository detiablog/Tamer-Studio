...
import { promptSettingsService } from "@/core/prompt-intelligence";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const settings = await promptSettingsService.getSettings(userId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const settings = await promptSettingsService.upsertSettings(userId, {
      autoOptimize: body.autoOptimize,
      autoInjectContext: body.autoInjectContext,
      autoValidate: body.autoValidate,
      defaultType: body.defaultType,
      maxPromptLength: body.maxPromptLength,
      showQualityScore: body.showQualityScore,
