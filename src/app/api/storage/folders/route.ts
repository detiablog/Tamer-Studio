...
export async function GET(request: NextRequest) {
  ...
  try {
    const folders = await storageEngine.listFolders(ctx.state.userSession!.userId);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const folder = await storageEngine.createFolder(ctx.state.userSession!.userId, body.name, body.parentId);
