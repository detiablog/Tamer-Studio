...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const characters = await imageStudioService.listCharacters(userId);
    return NextResponse.json(successResponse(characters));
  } catch (error) {
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const character = await imageStudioService.createCharacter(userId, {
      name: body.name,
