...
export class DefaultProviderPricing {
  private static defaultPricing: ProviderPricing[] = [
    ...
    },
    {
      ...
      capabilityId: "text",
      modelId: "gpt-4o-mini",
      inputPricePerUnit: 0.00000015,
      outputPricePerUnit: 0.0000006,
      unit: "token",
      currency: "USD",
      effectiveFrom: "2024-01-01",
    },
    ...
    },
    {
      ...
      inputPricePerUnit: 0.00000125,
      outputPricePerUnit: 0.000005,
      unit: "token",
      currency: "USD",
      effectiveFrom: "2024-01-01",
    },
    ...
    },
    {
      ...
      capabilityId: "text",
      modelId: "kilo-pro",
      inputPricePerUnit: 0.0000005,
      outputPricePerUnit: 0.0000015,
      unit: "token",
      currency: "USD",
      effectiveFrom: "2024-01-01",
    },
